 ...
 *
 * PAIR WARNING: Keep "Attr Fabled bonus stats.js" in a SEPARATE tab — both define tick() and the same helper names.
 */

var TICK_INTERVAL = 20; // once per second
var DEBUG = false;

/* Unique name so this never fights Attr Fabled bonus stats.js if both run. */
var BONUS_NAME = "§6Fabled Multi Bonus";
