...
function showRivalGuide(player) {
    ...
    msg(player, C + "e/rival accept <player>");
    msg(player, C + "e/rival decline <player>");
    msg(player, C + "e/rival remove <player>");
    msg(player, C + "e/rival list");
    msg(player, C + "e/rival stats [player]");
    line(player);
    msg(player, C + "6Official Battle");
    msg(player, C + "e/challenge <player>");
    msg(player, C + "e/challenge accept");
    msg(player, C + "e/challenge decline");
    msg(player, C + "e/challenge cancel");
    line(player);
